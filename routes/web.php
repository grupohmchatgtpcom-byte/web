...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/home/gerencial-data', [HomeController::class, 'getDashboardGerencialData'])->name('home.gerencial_data');
    Route::get('/bcv-rate', [HomeController::class, 'showBcvRate'])->name('home.bcv_rate');
    Route::post('/bcv-rate', [HomeController::class, 'storeBcvRate'])->name('home.bcv_rate.store');
    Route::post('/bcv-rate/fetch', [HomeController::class, 'fetchBcvRate'])->name('home.bcv_rate.fetch');
    Route::get('/bcv-rate/current', [HomeController::class, 'getCurrentBcvRateJson'])->name('home.bcv_rate.current');
    ...
    Route::get('/contacts/credit-status/{contact_id}', [ContactController::class, 'getCreditStatus'])->name('contacts.credit_status');
    ...
    Route::get('/reports/monthly-sales/export', [ReportController::class, 'exportMonthlySales'])->name('reports.monthly_sales.export');
    Route::get('/reports/purchases-period', [ReportController::class, 'purchasesByPeriod'])->name('reports.purchases_period');
    Route::get('/reports/libro-ventas', [ReportController::class, 'libroVentas'])->name('reports.libro_ventas');
    ...
    Route::get('stock-transfers/suggested-dispatch-excel', [StockTransferController::class, 'downloadSuggestedDispatchExcel']);
    ...
    Route::get('consolidado/calcular', [ConsolidadoController::class, 'calcular'])->name('consolidado.calcular');
    Route::get('consolidado/exportar', [ConsolidadoController::class, 'exportarExcel'])->name('consolidado.exportar');
