  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        {{-- Moneda del pago (GHM: dualidad USD/Bs) --}}
        <div class="col-md-4">
          <div class="form-group">
            {!! Form::label('currency_code', 'Moneda del pago:') !!}
            <div class="input-group">
              <span class="input-group-addon"><i class="fas fa-dollar-sign"></i></span>
              {!! Form::select('currency_code', ['USD' => 'USD — Dólares', 'VES' => 'VES — Bolívares'],
                  !empty($payment_line->currency_code) ? $payment_line->currency_code : 'USD',
                  ['class' => 'form-control select2', 'style' => 'width:100%;', 'id' => 'tp_currency_code']) !!}
            </div>
          </div>
        </div>
        {!! Form::hidden('exchange_rate_used', !empty($payment_line->exchange_rate_used) ? $payment_line->exchange_rate_used : 0, ['id' => 'tp_exchange_rate_used']) !!}
        <div class="clearfix"></div>
