...
<div class="modal-body">
  @php
    ...
    $purchaseFinalTotalBs = $bcvRate > 0 ? ((float) $purchase->final_total * $bcvRate) : 0;
  @endphp
  <div class="row">
    <div class="col-sm-12">
  ...
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      @if(!empty($purchase_order_nos))
        ...
        @endif
        @if($bcvRate > 0)
          <br><strong>Tasa BCV:</strong> {{ number_format($bcvRate, 4, '.', ',') }} Bs/USD
          @if(!empty($bcv_rate_info['rate_date']))
            <br><strong>Fecha tasa:</strong> {{ $bcv_rate_info['rate_date'] }}
          @endif
          @if(!empty($bcv_rate_info['is_fallback']))
            <br><span class="text-warning">Tasa en fallback</span>
          @endif
        @endif
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td></td>
            <td><span class="pull-right">Bs {{ number_format($purchaseFinalTotalBs, 2, '.', ',') }}</span></td>
          </tr>
          @endif
        </table>
      </div>
