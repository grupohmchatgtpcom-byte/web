    ...
    <section class="content no-print">
        ...
        @if ($bcvRate > 0)
            <div class="alert alert-info">
                ...
                @endif
                <input type="hidden" id="sell_bcv_rate" value="{{ $bcvRate }}">
            </div>
        @endif
        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    var bcvRate = parseFloat($('#sell_bcv_rate').val() || 0);
                    var bsSuffix = function(value){
                        if (!bcvRate || bcvRate <= 0) {
                            return '';
                        }

                        var bs = value * bcvRate;

                        return '<br><small class="text-muted">Bs ' + __number_f(bs, false, false, __currency_precision) + '</small>';
                    };

                    $('.footer_total_remaining').html(__currency_trans_from_en(footer_total_remaining) + bsSuffix(footer_total_remaining));
                    $('.footer_total_paid').html(__currency_trans_from_en(footer_total_paid) + bsSuffix(footer_total_paid));
                    $('.footer_sale_total').html(__currency_trans_from_en(footer_sale_total) + bsSuffix(footer_sale_total));
