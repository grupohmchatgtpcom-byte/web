...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td>
		...
		<input type="hidden" class="line_last_purchase_price" value="{{ !empty($product->last_purchased_price) ? (float) $product->last_purchased_price : 0 }}">
	...
	<td class="text-center">
		<span class="pos_line_total_bs_text">0.00</span>
	</td>
	<td class="text-center">
		<span class="pos_line_margin_text text-muted">0.00 (0.00%)</span>
	</td>
