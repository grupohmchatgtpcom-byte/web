                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <small class="text-muted">
                                        Bs&nbsp;<span class="payment_total_payable_bs">0,00</span>
                                        <span class="text-muted" style="font-size:10px;">(tasa&nbsp;<span class="payment_modal_bcv_rate">—</span>)</span>
                                    </small>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br>
                                    <small class="text-muted">
                                        Bs equiv.&nbsp;<span class="payment_total_paying_bs">0,00</span>
                                    </small>
                                </div>
