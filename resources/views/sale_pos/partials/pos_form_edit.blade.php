<div class="row">
	...
	<div class="col-md-4">
		<div class="form-group" style="width: 100% !important">
			...
			{{-- Panel de crédito GHM --}}
			<div id="pos_credit_panel" class="hide" style="margin-top:4px;">
				<div style="display:flex;gap:6px;flex-wrap:wrap;font-size:11px;line-height:1.6;">
					<span class="label label-default">Límite: <strong id="pos_credit_limit_val">-</strong></span>
					<span class="label label-danger">Usado: <strong id="pos_credit_used_val">-</strong></span>
					<span class="label label-success" id="pos_credit_avail_badge">Disponible: <strong id="pos_credit_avail_val">-</strong></span>
				</div>
				<div style="margin-top:3px;">
					<div class="progress progress-xs" style="margin-bottom:0;height:6px;">
						<div id="pos_credit_bar" class="progress-bar progress-bar-success" role="progressbar" style="width:0%"></div>
					</div>
					<small id="pos_credit_pct_text" class="text-muted"></small>
				</div>
			</div>
		</div>
	</div>
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					...
					<th class="text-center col-md-2">
						@lang('sale.subtotal')
					</th>				<th class="text-center col-md-2">
					Subtotal Bs
				</th>					<th class="text-center"><i class="fas fa-times" aria-hidden="true"></i></th>
				</tr>
			</thead>
			<tbody>
